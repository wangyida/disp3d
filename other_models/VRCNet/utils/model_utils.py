...
sys.path.append(os.path.join(proj_dir, "utils/pointnet2"))
import pointnet2_utils as pn2
sys.path.append(os.path.join(proj_dir, "../../distance/emd"))
import emd_module as emd
sys.path.append(os.path.join(proj_dir, "../../distance/chamfer_multidim"))
